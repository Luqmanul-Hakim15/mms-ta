...
<div class="flex justify-between mb-10">
    ...
    <!-- <div class="flex justify-center items-center gap-3">
        <button class="px-4 py-2 bg-primary text-lg rounded-xl text-white flex justify-center items-center">Filter&nbsp;<i class="ph-fill ph-funnel text-xl"></i>
        </button>
        <button class="px-4 py-2 bg-white border-black border rounded-xl flex justify-center items-center gap-2 text-base">Terbaru
            <i class="ph ph-caret-down text-xl"></i></button>
        <button class="px-2 w-10 h-10 py-2 bg-slate-200 flex justify-center items-center rounded-full"><i class="ph ph-caret-left text-xl"></i></button>
        <button class="px-2 w-10 h-10 py-2 bg-slate-200 flex justify-center items-center rounded-full"><i class="ph ph-caret-right text-xl"></i></button>
    </div> -->
</div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="flex gap-2 text-white justify-center items-center">
                    ...
                    <form action="{{ route('delete.incoming', $u->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this item?');">
                        @csrf
