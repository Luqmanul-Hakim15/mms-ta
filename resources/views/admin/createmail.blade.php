        ...
        <div class="bg-white">
            ...
            <form action="" enctype="multipart/form-data">
                ...
                <div class="mb-6" x-data="{ selectedOption: '', isOpen: false }">
                    ...
                    <select name="kasur" id="kasur" x-model="selectedOption" @change="$refs[selectedOption].focus(), isOpen = true, generateNomorSurat()" class="w-full py-3 px-4 mt-3 border-line border rounded-md focus:outline-spotSubtle aria-pressed:outline-blue-500" placeholder="isikan perihal surat anda">
...
@push('script')
    <script>
        function generateNomorSurat() {
            const kategori = document.getElementById('kasur').value;
            ...
            let nomorUrut = localStorage.getItem(`nomorUrut_${kategori}`);
            if (!nomorUrut) {
                nomorUrut = 1;
            } else {
                nomorUrut = parseInt(nomorUrut) + 1;
            }
            localStorage.setItem(`nomorUrut_${kategori}`, nomorUrut);

            nomorSuratInput.value = `${nomorUrut.toString().padStart(3, '0')}/${prefix}${bulan}/${tahun}`;
        }
    </script>
@endpush