    ...
    <div class="px-6 py-6 ">
        <div class="flex items-center mb-20 w-[400px] mx-auto justify-center">
            <div class="flex items-center text-white relative">
                <div class="rounded-full transition duration-500 ease-in-out h-12 w-12 py-3 border-2 border-primary {{ Request::routeIs('createmail') ? 'bg-primary text-white' : 'bg-none border-gray-300 text-gray-500'}}">
            ...
            <div class="flex items-center text-primary relative">
                <div class="rounded-full transition duration-500 ease-in-out h-12 w-12 py-3 border-2 border-gray-300 text-gray-500">
        ...
        <div class="bg-white">
            ...
            <div class="mb-6" x-data="{ selectedOption: '', isOpen: false }">
                ...
                <select name="kasur" id="kasur" x-model="selectedOption" @change="$refs[selectedOption].focus(), isOpen = true" class="w-full py-3 px-4 mt-3 border-line border rounded-md focus:outline-spotSubtle aria-pressed:outline-blue-500" placeholder="isikan perihal surat anda">
                ...
                <form action="{{ route('form.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="my-3" x-show="isOpen && selectedOption === 'Magang'" x-ref="Magang" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform -translate-y-2" x-transition:enter-end="opacity-100 transform translate-y-0" x-transition:leave="transition ease-in duration-300" x-transition:leave-start="opacity-100 transform translate-y-0" x-transition:leave-end="opacity-0 transform -translate-y-2">
                        ...
                        <div class="mb-3 flex gap-6">
                            ...
                            <div class="w-full">
                                <label for="namaPihakKedua">Nama pihak Magang</label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="alamat" id="alamat" class="w-full py-3 px-4 mt-3 border-line border rounded-md focus:outline-spotSubtle">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3 flex gap-6">
                            <div class="w-full">
                                <label for="posisiKerja">Penempatan Kerja</label>
                            ...
                            <div class="w-full">
                                <label for="Penempatan">Posisi Kerja</label>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-3 flex gap-6">
                                <div class="w-full">
                                    ...
                                    <input type="text" name="uangMakan" id="uangMakan" class="w-full py-3 px-4 mt-3 border-line border rounded-md focus:outline-spotSubtle" placeholder="0">
                                </div>
                                <div class="w-full">
                                    <label for="uangTransportasi">Uang transportasi</label>
                                    <input type="text" name="uangTransportasi" id="uangTransportasi" class="w-full py-3 px-4 mt-3 border-line border rounded-md focus:outline-spotSubtle" placeholder="0">
                                </div>
                                <div class="w-full">
                                    <label for="dibayarDalam">Dibayar dalam</label>
                                    <select name="dibayarDalam" id="dibayarDalam" class="w-full py-3 px-4 mt-3 border-line border rounded-md focus:outline-spotSubtle aria-pressed:outline-blue-500">
