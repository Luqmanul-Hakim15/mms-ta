                    ...
                    <div class="card-tempalte-1 text-center ">
                        <div class="relative" @mouseenter="footerTem='footer{{ $d->id }}'" @mouseleave="footerTem=null">
                            ...
                            <div x-show="footerTem ==='footer{{ $d->id }}'" class="absolute flex items-center justify-center gap-4 top-0 left-0 right-0 bottom-0 inset-0 bg-gray-500 bg-opacity-75">
                                @if($d->default == 0)
                                <button class="bg-amber-400 rounded-full w-10 h-10 text-white flex justify-center items-center hover:bg-opacity-50 p-2"><i class="fa fa-star"></i></button>
                                @endif
                ...
                @endforeach
                        ...
                        <div class="card-tempalte-1 text-center ">
                            <div class="relative" @mouseenter="footerTem='footer2'" @mouseleave="footerTem=null">
                                ...
                                <img src="{{ asset('images/footer.jpg') }}" class=" " alt="">
                            </div>
