         ...
         <div class="pt-28 h-screen shadow-xl px-3 w-full">
             ...
             <div>
              ...
              <ul class="flex flex-col gap-3 pb-20">
                  <li>
                      <a href="akun.html" class="w-full block p-3  text-black rounded-lg font-medium hover:bg-primary hover:bg-opacity-5 hover:text-black"><i class="ph-fill ph-user fa-lg me-3"></i></i> Akun</a>
                  </li>
                  <li>
                      <a href="ganti-password.html" class="w-full block p-3  text-black rounded-lg font-medium hover:bg-primary hover:bg-opacity-5 hover:text-black"><i class="ph-fill ph-key fa-lg me-3"></i>Ganti Password</a>
                  </li>
                  <li>
                    <a href="users.html" class="w-full block p-3  text-black rounded-lg font-medium hover:bg-primary hover:bg-opacity-5 hover:text-black"><i class="ph-fill ph-users-three fa-lg me-3"></i>Akun Users</a>
                </li>
              </ul>
             </div>
         </div> 
